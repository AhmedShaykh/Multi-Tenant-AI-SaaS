        ...
        },
        {
            ...
            icon: (
                <svg
                    ...
                    aria-hidden="true"
                >
                    <path d="M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2ZM8.5 18H6V9.5h2.5V18ZM7.25 8.35A1.45 1.45 0 1 1 7.25 5.45a1.45 1.45 0 0 1 0 2.9ZM18 18h-2.5v-4.15c0-.99-.02-2.27-1.38-2.27-1.38 0-1.59 1.08-1.59 2.2V18H10V9.5h2.4v1.16h.03c.33-.63 1.15-1.3 2.37-1.3 2.53 0 3 1.67 3 3.84V18Z" />
                </svg>
            )
        },
        {
            href: "mailto:main.xyfora@gmail.com",
            label: "Email",
